...
function weather(){
  ...
  function getWeather(response) {
      ...
      oSpan[2].innerHTML = arr.reverse().join(' ~ ');
  ...
  new Vue({
    ...
    data: function data() {
      return {
        ...
        hotNews: [],
        meiTus: [],
        banners: [{ src: '<img title="万恶的战争" alt="万恶的战争" src="./images/z1.jpg">' }, { src: '<img title="万恶的战争" alt="万恶的战争" src="./images/z2.jpg">' }, { src: '<img title="万恶的战争" alt="万恶的战争" src="./images/z3.jpg">' }, { src: '<img title="万恶的战争" alt="万恶的战争" src="./images/z4.jpg">' }, { src: '<img title="万恶的战争" alt="万恶的战争" src="./images/z5.jpg">' }],
        test: 'nudfdfd'
      };
    },
    ...
    mounted: function mounted() {
      ...
      // 新闻+美图切换
      $(".par4").slide({ effect: "fade", autoPlay: false, trigger: "mouseover", easing: "swing", delayTime: 500, triggerTime: 0 });
      ...
      $(window).load(function () {
        ...
        // 微新闻
        $(".m_wnews").slide({ mainCell: "#miniNewsRegion", effect: "topLoop", autoPlay: true });
      });

      // 懒加载
      $("img").lazyload({
        // placeholder: './images/2.jpg', // 占位图
        effect: "fadeIn",
        threshold: 200,
        failure_limit: 5
      });
    ...
    methods: {
      read: function read() {
        ...
        $.ajax({
          ...
          success: function success(data) {
            _this.books = data.data.filter(function (v, i) {
              return i < 10;
            });
          },
      ...
      hotNew: function hotNew() {
        var _this = this;
        $.ajax({
          url: 'https://www.apiopen.top/journalismApi',
          type: 'get',
          success: function success(data) {
            // _this.hotNews = data.data.toutiao;
            _this.hotNews = data.data.toutiao.filter(function (v, i) {
              return i < 10;
            });
          },
          error: function error(e) {
      ...
      ajaxMeiTu: function ajaxMeiTu() {
        var _this = this;
        $('.page p').pagination({
          pageCount: 29,
          mode: 'fixed',
          callback: function callback(index) {
            _this.meiTu(index.getCurrent());
          }
        }, function (api) {
          _this.meiTu(api.getCurrent());
        });
      }
  ...
  Calendar.prototype = {
    ...
    renderDOM: function () { // 渲染DOM
      ...
      var _titleStr = '<a href="javascript:;" class="title"></a>'+
                      '<a href="javascript:;" id="backToday">Today</a>'+
                      '<div class="arrow">'+
